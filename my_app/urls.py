...
from .views import (
    ...
    logout_view, premium_page, toggle_favorite, favorites_page,
    watch_history_page, reels, aloqa, news_feed, news_detail,
    toggle_like, next_story_view, prev_story_view, story_view,
    mark_story_seen,

    reels_feed, reel_detail, toggle_reel_like, add_reel_comment,
    reel_comments_api, reel_share,

    settings_privacy, settings_devices, settings_premium,
    settings_telegram, settings_general, user_mini_profile_api,

    anime_category, notice, delete_comment, service_worker_view,
    ...
    news_load_more, vip_buy_balance, debt_request_add,
    balance_topup_add, jackpot_redeem, imkan_toggle_beta_home,
